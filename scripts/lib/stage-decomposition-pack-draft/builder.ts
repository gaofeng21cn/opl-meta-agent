...
function buildArtifactMorphologyContract({
  ...
  return {
    ...
    target_extent_policy: {
      ...
      shortfall_with_consumable_artifact: 'completed_with_quality_debt',
      shortfall_without_consumable_artifact: 'typed_blocker',
      shortfall_blocks_stage_transition: false,
      shortfall_blocks_quality_or_ready_claims: true,
    },
    ...
    realistic_task_review_policy: {
      required_before_baseline_quality_acceptance: true,
      missing_review_with_consumable_artifact: 'completed_with_quality_debt',
      missing_review_blocks_stage_transition: false,
    ...
    authority_boundary: {
      ...
      target_domain_owner_acceptance_blocks_stage_transition: false,
      target_domain_owner_acceptance_blocks_quality_or_ready_claims: true,
    },
  };
}
  ...
  return [
    ...
    },
    {
      ...
      body: [
        ...
        '- A consumable artifact advances to the next stage even when independent review or owner acceptance is pending; record completed_with_quality_debt and keep quality/export/ready claims closed.',
        '',
        'Hard-stop conditions:',
        '',
        '- No consumable artifact, unreadable/corrupt artifact, missing execution identity/currentness, permission/credential failure, explicit human decision, or authority violation.',
        '- Missing prompt, skill/tool, knowledge, source, workspace, review, or quality-gate refs becomes quality debt when a consumable artifact exists.',
        ...
        '- Missing independent review path, stale review evidence, attempt self-review, shared-context review, or missing owner receipt blocks quality/export/readiness claims but not stage transition when a consumable artifact exists.',
