...
function main(): void {
  ...
  const payload = {
    ...
    work_order_readback: {
      agent_evolution_decision_ref: workOrder.agent_evolution_decision_ref,
      failure_class: workOrder.failure_class,
      target_owner_route: workOrder.target_owner_route,
      target_editable_surface_refs: workOrder.target_editable_surface_refs,
      forbidden_surfaces: workOrder.forbidden_surfaces,
      expected_behavior_delta: workOrder.expected_behavior_delta,
      verification_refs: workOrder.verification_refs,
      owner_closeout_readback: workOrder.owner_closeout_readback,
    },
