...
- `script_to_pack_hygiene`：developer work-order 默认 policy 已迁入 contract-backed projection；其余稳定 agent-building policy 必须继续迁回 declarative pack、contracts、authority refs 或 OPL primitive；脚本退役只能按 machine gate 证明。
