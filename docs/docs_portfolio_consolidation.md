...
| History / provenance | `docs/history/README.md`, `docs/history/process/README.md`, `docs/history/process/*.md` |
...
Dated coverage tranches and folded process history are indexed only by [process history](./history/process/README.md). This governance file keeps lifecycle roles, current inventory groups, rules and reopening conditions; it does not duplicate dated ledger names or coverage history.
