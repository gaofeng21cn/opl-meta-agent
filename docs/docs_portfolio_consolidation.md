...
| `docs/history/process/README.md`, `docs/history/process/retired-surface-provenance.md`, `docs/history/process/target-agent-machine-field-retirement.md` | 压缩后的 process archive index、retired-surface provenance 与 target-agent field-only closeout provenance | `historical_archive_index` / `historical_provenance` | 不保留逐日 closeout 长清单；当前 truth 回到 active/core docs、contracts、source 和 tests。 |
...
| History / provenance | `docs/history/README.md`, `docs/history/process/README.md`, `docs/history/process/retired-surface-provenance.md`, `docs/history/process/target-agent-machine-field-retirement.md` |
...
- Active docs 只保留当前计划、差距、迁移门和 durable status。过程 proof、dated closeout、历史路线和 coverage tranche 只允许压缩成 `docs/history/process/README.md`、`docs/history/process/retired-surface-provenance.md`、`docs/history/process/target-agent-machine-field-retirement.md`、OPL family ledger、machine receipts 或 git history。
