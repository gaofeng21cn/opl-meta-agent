...
| `docs/history/process/*.md` | dated process/provenance archives | `history_provenance` | 只记录当时审计和 foldback 过程；当前 truth 回到 active/core docs。 |
...
| History / provenance | `docs/history/README.md`, `docs/history/process/README.md`, `docs/history/process/2026-05-30-oma-private-inventory-process-ledger.md`, `docs/history/process/2026-06-02-oma-docs-portfolio-coverage-ledger-archive.md`, `docs/history/process/2026-06-03-oma-docs-lifecycle-cleanup.md` |
...
- Active docs 只保留当前计划、差距、迁移门和 durable status。过程 proof、dated closeout、历史路线和 coverage tranche 只留在 `docs/history/process/**`、OPL family ledger、machine receipts 或 git history。
- `docs/docs_portfolio_consolidation.md` 不再追加 dated coverage ledger。未来 coverage/run records 应进入 `docs/history/process/**`；durable conclusions 必须折回 active gap plan、private implementation inventory、核心 docs、contracts、source 或 tests。
...
Dated coverage tranches and folded process history that previously lived in this governance file are archived in [OMA docs portfolio coverage ledger archive](./history/process/2026-06-02-oma-docs-portfolio-coverage-ledger-archive.md). Current lifecycle cleanup for 2026-06-03 is recorded in [OMA docs lifecycle cleanup](./history/process/2026-06-03-oma-docs-lifecycle-cleanup.md).
