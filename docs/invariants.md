...
- The old direct script-authored stage graph may remain only as an explicit compatibility fixture. It must not be described as the default AI-first build-agent-baseline path.
