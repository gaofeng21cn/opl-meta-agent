...
- Keep `agent/` as a real domain pack: required pack files and `stage_control_plane.prompt_refs` must resolve to repo files that are non-empty and free of placeholder markers.
