...
| --- | --- | --- | --- |
| `candidate_agent_package_builder` | `scripts/build-agent-baseline.ts`, `scripts/lib/meta-agent-loop.ts` | candidate agent package ref、owner receipt ref | generic runtime owner、target truth write、target quality/export verdict |
