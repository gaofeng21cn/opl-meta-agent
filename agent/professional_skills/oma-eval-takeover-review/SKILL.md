...
- Use AI judgment here to interpret baseline and delivery gates: distinguish runnable evidence, generated-interface readiness, owner-route proof, no-forbidden-write proof, no-patch coordination, typed blocker shape, and target-domain acceptance. Gate scripts may fail closed only on the delivery/promotion/readiness claim; missing refs become quality debt or a progress diagnostic and never fail closed the stage transition. This skill decides whether present refs are meaningful.
