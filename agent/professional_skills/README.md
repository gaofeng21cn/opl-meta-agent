...
`contracts/capability_map.json` 覆盖本目录全部 9 个 repo-local professional skills，并为 target improvement routing 登记 locator 元数据。
...
- `oma-script-to-pack-hygiene-reviewer/SKILL.md`
