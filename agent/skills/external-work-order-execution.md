...
4. 写入 delegation receipt，记录 OMA 只做薄委托，target worktree lifecycle、queue、attempt ledger、absorb、cleanup 和 execution receipt 均由 OPL Agent Lab / target owner 控制面持有。
