...
Machine boundary: 本文是人读支撑索引。机器 truth 继续归 `contracts/pack_compiler_input.json`、`agent/stages/manifest.json`、本目录非 README skill 文件和 tests；本文不作为 generated Skill surface、runtime tool contract 或 `required_domain_pack_paths`。
