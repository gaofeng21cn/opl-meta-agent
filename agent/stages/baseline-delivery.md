...
只交付已经通过 baseline gate 且消费过结构化 AI reviewer evaluation 的 versioned agent package。delivery 包含 docs、contracts、tests、runbook、review provenance 和 boundary receipt；不把 smoke sample 或 proposal 写成 production delivery。
...
- receipt 必须引用 AI reviewer critique、suggestions、source refs、verdict 和 provenance。
