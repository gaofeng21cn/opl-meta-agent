...
| `stage_prompt_skill_tool_separation` | Prompt / Skill / Tool separation | Stage prompts define goals and accepted answer shapes; professional skills carry domain methods; tool catalogs describe affordances and limits. |
