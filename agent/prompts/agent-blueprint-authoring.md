...
Project `DesignRequest.constraints.permission_refs` and request-owned `owner_authority_refs` exactly into separate authority-policy fields. Never add, drop, or reinterpret either set.
