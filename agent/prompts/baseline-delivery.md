...
5. 对照 baseline delivery gate 检查 scaffold validation、generated interface、Agent Lab evidence、AI reviewer critique/suggestions/source refs、morphology refs、forbidden writes 和 rollback path。
